    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reffer_code', models.CharField(blank=True, max_length=30, null=True)),
                ('Reffer_money', models.FloatField(default=0)),
                ('reffer_by', models.CharField(default='none', max_length=30)),
                ...
                ('razorpay_contact', models.CharField(blank=True, max_length=100, null=True)),
